...
namespace NCMS.Controllers
{
    ...
    {
        //string username = filterContext.HttpContext.User.Identity.GetUserName;
        ...
        public ActionResult Index()
        {
            ...
            return View(db.Timesheets.Where(x => x.Email == User.Identity.Name).ToList());
       ...
       // return private Json(Timesheet, JsonRequestBehavior.AllowGet);
    }
}
